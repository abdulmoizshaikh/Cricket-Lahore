        ...
        <View style={styles.wholecontainer}>
          <Container style={{paddingTop:23,backgroundColor:'#CBD8E9'}}>
              <Header style={{backgroundColor:'#154360'}}>
                ...
                <Body>
                    <Text style={{color:'#fff',fontWeight:'bold',fontSize:20,paddingLeft:'10%',paddingRight:'10%'}}>User Profile </Text>
                </Body>
              </Header>
              ...
              <Card>
                    <CardItem style={{backgroundColor:'#154360'}}>
                        <Body>
<Text style={{color:"#fff",fontSize:18,fontWeight:'bold'}}>{this.state.user.first_name}</Text>
<Text style={{color:"#fff",fontSize:18,fontWeight:'bold'}}>{this.state.user.email}</Text>
<Text style={{color:"#fff",fontSize:18,fontWeight:'bold'}}>{this.state.user.contact}</Text>
                ...
                <Card style={{borderRadius:20}}>
                    ...
                    <Body>
                        ...
                        <Text></Text>
                        <Label style={{color:"black",fontWeight:'bold'}}>Total Matches :</Label>
                        <Text></Text>
                        <Label style={{color:"black",fontWeight:'bold'}}>Total 100's :</Label>
                        <Text></Text>
                        <Label style={{color:"black",fontWeight:'bold'}}>Total 50's :</Label>
                        <Text></Text>
                        <Label style={{color:"black",fontWeight:'bold'}}>Average :</Label>
                        <Text></Text>
                        <Label style={{color:"black",fontWeight:'bold'}}>Strike Rate :</Label>
                        <Text></Text>
                    </Body>
                    </CardItem>
                </Card>
