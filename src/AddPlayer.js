...
import {Input,Button,Container,Left,Header,Body, Content,Icon, Card, CardItem} from 'native-base';
        ...
        <View style={{flex:1}}>
         ...
         <ImageBackground source={myBackground} style={styles.backgroundImage}>  
            <Header style={{backgroundColor:'#154360'}} >
                        ...
                        <Body>
                            <Text style={{color:'#fff',fontWeight:'bold',fontSize:25}}>Add Player</Text>
                        </Body>
                    </Header> 
    ...
    <Content>
      <View  style={{padding:10}}>
          <Card >
            <CardItem  >
              <Body>
              <Text style={{fontWeight:'bold',fontSize:20}}>Email / Contact #  :</Text>
                  <Input
                  style={{backgroundColor:"#EDEDED"}}
                    ...
                    />
                {this.state.usernameFlag ? <Text style={{color:"red",fontWeight:'bold'}}>
                      field is empty
                    </Text> 
                    : 
                    <View></View>}
