...
import { AsyncStorage,View , StyleSheet,Dimensions,ImageBackground,Alert,Text,Image} from 'react-native';
...
<Container style={{paddingTop:23,backgroundColor:'#154360'}}>
              ...
              <Body>
                  <Text style={{color:'#fff',fontWeight:'bold',fontSize:20,paddingLeft:'10%',paddingRight:'10%'}}>Create OR Join Team</Text>
              </Body>
              <Right>
                ...
                <View style={styles.container}>
                    <View style={styles.buttonContainer}>
                        <Button
                        //primary
                       style={{backgroundColor:'#3C7DFE',justifyContent:'center'}} 
                        onPress={() => this.props.navigation.navigate('CreateTeam')}
                        >
                        <Text style={{color: 'white',textAlign:'center'}}>Create Team</Text>
                        </Button>
                    </View>
                    ...
                    <View style={styles.buttonContainer}>
                       ...
                       >
                        <Text style={{color: 'white',alignItems:"center",justifyContent:"center"}}>Join Team</Text>
                        </Button>
                    </View>
                </View>
                </Container>
