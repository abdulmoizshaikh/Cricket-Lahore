...
export default class JoinTeam extends Component {
  ...
  getTeams = () => {
    AsyncStorage.getItem("batting_id1").then(string => {
      var bat = JSON.parse(string);
      this.setState({ battingTeam_id: bat });
      console.log("bating team ID" + this.state.battingTeam_id);
    });
    AsyncStorage.getItem("bowling_id1").then(string => {
      var bowl = JSON.parse(string);
      this.setState({ bowlingTeam_id: bowl });
      console.log("balling team ID" + this.state.bowlingTeam_id);
      //this.getBattingTeam();
    });
    AsyncStorage.getItem("tournamentID").then(string => {
      var trmntid = JSON.parse(string);
      this.setState({ tournament_id: trmntid });
      console.log("tournament ID" + this.state.tournament_id);
    });
    AsyncStorage.getItem("match_id").then(string => {
      var matchid = JSON.parse(string);
      this.setState({ match_id: matchid });
  ...
  getBattingTeam = () => {
    ...
    var self = this;
    axios
      .post(global.url + "/api/showselectedplayer", {
  ...
  getbowlingTeam = () => {
    ...
    var self = this;
    axios
      .post(global.url + "/api/showPlayerBowler", {
  ...
  storeData = () => {
    var self = this;
    axios
      .post(global.url + "/api/ScoreBoard", {
        team_id: self.state.battingTeam_id,
