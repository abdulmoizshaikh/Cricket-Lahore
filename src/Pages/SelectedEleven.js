                  ...
                  <Card>
                    <CardItem style={{ backgroundColor: "#154360" }}>
                      <Body>
                        ...
                        >
                          {this.Capitalize(
                            selectedPlayers.get_username.first_name
                          )}
                        </Text>
                      </Body>
                    </CardItem>
                  ...
                  <CardItem style={{ backgroundColor: "#fff" }}>
                    <Body>
                      ...
                      >
                        ...
                        {selectedPlayers.get_username.email}
                      </Text>
                      <Text
                        style={{
                          color: "black",
                      ...
                      >
                        ...
                        {selectedPlayers.get_username.contact}
                      </Text>
                      ...
                      >
                        <Button
                          ...
                          onPress={() =>
                            this.setState(
                              {
                                delID: selectedPlayers.get_username.id.toString()
                              },
