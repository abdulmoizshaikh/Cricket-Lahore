...
import {StyleSheet, View,Text,ToastAndroid, KeyboardAvoidingView,TouchableOpacity} from 'react-native';
import {Item, Label, Input,Button,Container,Left,Header,Body, Content,Icon, Card,Picker, CardItem} from 'native-base';
...
axios.post(global.url+"/api/playerRole",{
...
saveUpdates=()=> {
    ...
    var self=this;
axios.post(global.url+"/api/RoleProfileUpdate",{
        ...
        <View style={{flex:1}}>
          ...
          <Card >
            <CardItem style={{backgroundColor:"#fff"}} >
              <Body>
              <Label style={{color:"black",fontWeight:'bold'}}>DOB : </Label>
                <Item >
                    <Input
                ...
                <Label style={{color:"black",fontWeight:'bold'}}>Role : </Label>
                <Picker
              note
              mode="dropdown"
              style={{ width: 250 }}
