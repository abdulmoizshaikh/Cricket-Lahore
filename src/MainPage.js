...
import { View ,Alert,Image, Text,ImageBackground,TouchableOpacity, Dimensions, StyleSheet} from 'react-native';
import { Container, Header, Left,  Right, Button, Icon,Body,Item,Input,Card,Content,CardItem} from 'native-base';
import {
...
_signOutAsync = async () => {
              ...
              <Container style={{paddingTop:23}}>
                <ImageBackground source={myBackground} style={styles.backgroundImage}>
                  <Header  style={{backgroundColor:'#154360'}}>
                    ...
                    <Body>
                      <Text style={{color:'#fff',fontWeight:'bold',fontSize:25,paddingLeft:'10%'}}>Cricket Zone</Text>
                    </Body>
                    <Right>
  ...
  <View style={{padding:10}}>
                      <View style={{ flexDirection: 'row'}}>
                        <Content> 
                          <TouchableOpacity style={styles.touchablestyle} onPress={() => this.props.navigation.navigate('TeamPlayers')}>       
                          <Card>
                        ...
                        <Text></Text>
                        <Content>
                        <TouchableOpacity style={styles.touchablestyle}  onPress={() => this.props.navigation.navigate('SelectedEleven')}>        
                          <Card>
                            <CardItem style={styles.cardcolor}>
                              <Body style={styles.bodystyle}>
                              <Image
                        ...
                        <View style={{ flexDirection: 'row'}}>
                        <Content> 
                        <TouchableOpacity style={styles.touchablestyle} onPress={() => this.props.navigation.navigate('UpcommingTrmnt')}>       
                          <Card>
                            <CardItem style={styles.cardcolor}>
                              <Body style={styles.bodystyle}>
                              <Image
                        ...
                        <Content>
                        <TouchableOpacity style={styles.touchablestyle} onPress={() => this.props.navigation.navigate('JoinedTrmnt')}>        
                          <Card>
                            <CardItem style={styles.cardcolor}>
                              <Body style={styles.bodystyle}>
                              <Image
                        ...
                        <Content> 
                        <TouchableOpacity style={styles.touchablestyle} onPress={() => this.props.navigation.navigate('AddPlayer')}>       
                          <Card>
                            <CardItem style={styles.cardcolor}>
                              <Body style={styles.bodystyle}>
                              <Image
